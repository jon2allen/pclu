...
CLUREF *ret_2;
  ...
  LINE(51);
    {
        ...
        if (T_1_1.num < duOPfixups.array->ext_low || T_1_1.num > duOPfixups.array->ext_high ) {
            fprintf(stderr, "DEBUG BOUNDS FAIL at line 263: idx=%ld fixups ext_low=%ld ext_high=%ld\n",
                    T_1_1.num, duOPfixups.array->ext_low, duOPfixups.array->ext_high);
            err = ERR_bounds;
            goto ex_0;}
  ...
  LINE(53);
        ...
        if (T_2_1.num < duOPfixups.array->ext_low || T_2_1.num > duOPfixups.array->ext_high) {
            fprintf(stderr, "DEBUG BOUNDS FAIL at line 282: idx=%ld fixups ext_low=%ld ext_high=%ld\n",
  ...
  LINE(54);
    ...
    if (T_1_1.num < duOPstore.array->ext_low || T_1_1.num > duOPstore.array->ext_high ) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 299: idx=%ld store ext_low=%ld ext_high=%ld (DU get)\n",
                T_1_1.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
...
CLUREF specs;
  ...
  LINE(58);
    ...
    {
    if (T_1_1.num < duOPstore.array->ext_low || T_1_1.num > duOPstore.array->ext_high) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 344: idx=%ld store ext_low=%ld ext_high=%ld\n",
                T_1_1.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
...
CLUREF *ret_1;
  ...
  LINE(68);
    ...
    if (T_1_1.num < duOPcache.array->ext_low || T_1_1.num > duOPcache.array->ext_high ) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 410: idx=%ld cache ext_low=%ld ext_high=%ld\n",
                T_1_1.num, duOPcache.array->ext_low, duOPcache.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
...
CLUREF specs;
  ...
  LINE(72);
    ...
    {
    if (T_1_1.num < duOPcache.array->ext_low || T_1_1.num > duOPcache.array->ext_high) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 452: idx=%ld cache ext_low=%ld ext_high=%ld\n",
                T_1_1.num, duOPcache.array->ext_low, duOPcache.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
...
CLUREF *ret_2;
  ...
  LINE(76);
    ...
    T_1_1.num = d.vec->data[0];
    if (T_1_1.num < duOPstore.array->ext_low || T_1_1.num > duOPstore.array->ext_high ) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 494: idx=%ld store ext_low=%ld ext_high=%ld\n",
                T_1_1.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
    T_1_2.num = duOPstore.array->store->data[T_1_1.num - duOPstore.array->ext_low + duOPstore.array->int_low];
...
CLUREF specs;
  ...
  LINE(80);
    ...
    T_1_1.num = d.vec->data[0];
    if (T_1_1.num < duOPstore.array->ext_low || T_1_1.num > duOPstore.array->ext_high ) {
        fprintf(stderr, "DEBUG BOUNDS FAIL at line 544: idx=%ld store ext_low=%ld ext_high=%ld\n",
                T_1_1.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
        err = ERR_bounds;
        goto ex_0;}
    T_1_2.num = duOPstore.array->store->data[T_1_1.num - duOPstore.array->ext_low + duOPstore.array->int_low];
  ...
  LINE(81);
        ...
        if (T_2_1.num < duOPstore.array->ext_low || T_2_1.num > duOPstore.array->ext_high) {
            fprintf(stderr, "DEBUG BOUNDS FAIL at line 556: idx=%ld store ext_low=%ld ext_high=%ld\n",
                    T_2_1.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
            err = ERR_bounds;
            goto ex_0;}
    ...
    for (;;) {
        ...
        if (T_1_2.num) {
            if (duOPkeepmax.num < duOPstore.array->ext_low || duOPkeepmax.num > duOPstore.array->ext_high ) {
                fprintf(stderr, "DEBUG BOUNDS FAIL at line 729: idx=%ld store ext_low=%ld ext_high=%ld\n",
                        duOPkeepmax.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
                err = ERR_bounds;
                goto ex_0;}
...
errcode duOPreset()
  ...
  LINE(109);
            ...
            if (i.num < duOPstore.array->ext_low || i.num > duOPstore.array->ext_high) {
                fprintf(stderr, "DEBUG BOUNDS FAIL at line 799: idx=%ld store ext_low=%ld ext_high=%ld\n",
                        i.num, duOPstore.array->ext_low, duOPstore.array->ext_high);
                err = ERR_bounds;
                goto ex_0;}
  ...
  LINE(110);
            ...
            if (i.num < duOPfixups.array->ext_low || i.num > duOPfixups.array->ext_high) {
                fprintf(stderr, "DEBUG BOUNDS FAIL at line 809: idx=%ld fixups ext_low=%ld ext_high=%ld\n",
                        i.num, duOPfixups.array->ext_low, duOPfixups.array->ext_high);
                err = ERR_bounds;
                goto ex_0;}
  ...
  LINE(111);
            ...
            if (i.num < duOPcache.array->ext_low || i.num > duOPcache.array->ext_high) {
                fprintf(stderr, "DEBUG BOUNDS FAIL at line 825: idx=%ld cache ext_low=%ld ext_high=%ld\n",
                        i.num, duOPcache.array->ext_low, duOPcache.array->ext_high);
                err = ERR_bounds;
                goto ex_0;}
