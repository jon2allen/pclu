...
CLUREF STR_bad_040hdr_040in_040pass1_072_040;
CLUREF STR_bad_040hdr_040in_040pass2_072_040;
...
errcode gcr_own_init_proc()
{
    ...
    enter_own_init_proc();
        ...
        stringOPcons("bad hdr in pass1: ", CLU_1, CLU_18, &STR_bad_040hdr_040in_040pass1_072_040);
        stringOPcons("bad hdr in pass2: ", CLU_1, CLU_18, &STR_bad_040hdr_040in_040pass2_072_040);
        gcr_own_init = 1;
        {signal(ERR_ok);}
...
CLUREF ch;
  ...
  LINE(128);
            ...
            CLUREF T_3_1;
            CLUREF T_3_2;
            err = intOPunparse(hdr, &T_3_1);
            if (err != ERR_ok) goto ex_0;
            err = stringOPconcat(STR_bad_040hdr_040in_040pass1_072_040, T_3_1, &T_3_2);
            if (err != ERR_ok) goto ex_0;
            elist[0] = T_3_2;
            {signal (ERR_not_possible);}}
            }}}}}/* end if */
...
CLUREF ch;
  ...
  LINE(196);
            ...
            err = intOPunparse(hdr, &T_3_1);
            if (err != ERR_ok) goto ex_0;
            err = stringOPconcat(STR_bad_040hdr_040in_040pass2_072_040, T_3_1, &T_3_2);
            if (err != ERR_ok) goto ex_0;
            elist[0] = T_3_2;
            {signal (ERR_not_possible);}}
            }}}}}/* end if */
